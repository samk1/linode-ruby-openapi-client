# LinodeOpenapiClient::PostRebuildNodeBalancerConfigRequest
...
| **nodes** | [**Array&lt;PostRebuildNodeBalancerConfigRequestAllOfNodesInner&gt;**](PostRebuildNodeBalancerConfigRequestAllOfNodesInner.md) | The NodeBalancer Nodes that serve this Config.  Some considerations for Nodes when rebuilding a config:    - Current Nodes excluded from the request body will be deleted from the Config.   - Current Nodes (identified by their Node ID) will be updated.   - New Nodes (included without a Node ID) will be created. |  |
...
instance = LinodeOpenapiClient::PostRebuildNodeBalancerConfigRequest.new(
  check_interval: 90,
  proxy_protocol: none,
  check: http_body,
