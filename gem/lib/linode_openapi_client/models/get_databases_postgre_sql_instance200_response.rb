...
module LinodeOpenapiClient
  ...
  class GetDatabasesPostgreSqlInstance200Response
    ...
    def self.openapi_types
      {
        ...
        :'id' => :'Integer',
        :'status' => :'String',
        :'hosts' => :'GetDatabasesPostgreSqlInstance200ResponseHosts',
        :'total_disk_size_gb' => :'Integer',
        :'cluster_size' => :'Integer',
        :'allow_list' => :'Array<String>',
        :'replication_commit_type' => :'String',
        :'engine' => :'String',
        :'updates' => :'GetDatabasesPostgreSqlInstance200ResponseUpdates',
        :'port' => :'Integer',
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `LinodeOpenapiClient::GetDatabasesPostgreSqlInstance200Response` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `LinodeOpenapiClient::GetDatabasesPostgreSqlInstance200Response`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
    ...
    def hash
      [region, created, used_disk_size_gb, id, status, hosts, total_disk_size_gb, cluster_size, allow_list, replication_commit_type, engine, updates, port, ssl_connection, version, updated, replication_type, encrypted, label, type].hash
    end
