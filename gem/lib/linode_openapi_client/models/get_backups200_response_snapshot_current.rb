...
module LinodeOpenapiClient
  ...
  class GetBackups200ResponseSnapshotCurrent
    ...
    def self.openapi_types
      {
        ...
        :'id' => :'Integer',
        :'disks' => :'Array<GetBackups200ResponseSnapshotCurrentDisksInner>',
        :'updated' => :'Time',
        :'status' => :'String',
        :'finished' => :'Time',
        :'available' => :'Boolean',
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `LinodeOpenapiClient::GetBackups200ResponseSnapshotCurrent` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `LinodeOpenapiClient::GetBackups200ResponseSnapshotCurrent`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
    ...
    def valid?
      ...
      status_validator = EnumAttributeValidator.new('String', ["paused", "pending", "running", "needsPostProcessing", "successful", "failed", "userAborted"])
      return false unless status_validator.valid?(@status)
      type_validator = EnumAttributeValidator.new('String', ["auto", "snapshot"])
    ...
    def status=(status)
      validator = EnumAttributeValidator.new('String', ["paused", "pending", "running", "needsPostProcessing", "successful", "failed", "userAborted"])
    ...
    def type=(type)
      validator = EnumAttributeValidator.new('String', ["auto", "snapshot"])
    ...
    def hash
      [created, configs, id, disks, updated, status, finished, available, type, label].hash
    end
