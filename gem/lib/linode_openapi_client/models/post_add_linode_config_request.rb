...
module LinodeOpenapiClient
  class PostAddLinodeConfigRequest
    ...
    def self.openapi_types
      {
        :'label' => :'String',
        :'helpers' => :'PostAddLinodeConfigRequestAllOfHelpers',
        :'run_level' => :'String',
        ...
        :'devices' => :'PostAddLinodeConfigRequestAllOfDevices',
        :'virt_mode' => :'String'
      }
    end
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `LinodeOpenapiClient::PostAddLinodeConfigRequest` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `LinodeOpenapiClient::PostAddLinodeConfigRequest`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
    ...
    def valid?
      ...
      return false if @label.to_s.length > 48
    ...
    def hash
      [label, helpers, run_level, memory_limit, kernel, comments, root_device, id, interfaces, devices, virt_mode].hash
    end
