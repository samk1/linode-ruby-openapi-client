...
module LinodeOpenapiClient
  ...
  class GetEntityTransfers200ResponseAllOfDataInner
    ...
    def self.openapi_types
      {
        :'created' => :'Time',
        :'entities' => :'GetEntityTransfers200ResponseAllOfDataInnerEntities',
        :'is_sender' => :'Boolean',
        :'expiry' => :'Time',
        :'token' => :'String',
        :'status' => :'String',
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `LinodeOpenapiClient::GetEntityTransfers200ResponseAllOfDataInner` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `LinodeOpenapiClient::GetEntityTransfers200ResponseAllOfDataInner`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'is_sender')
        self.is_sender = attributes[:'is_sender']
      end
    ...
    def valid?
      ...
      status_validator = EnumAttributeValidator.new('String', ["accepted", "canceled", "completed", "failed", "pending", "stale"])
    ...
    def status=(status)
      validator = EnumAttributeValidator.new('String', ["accepted", "canceled", "completed", "failed", "pending", "stale"])
    ...
    def hash
      [created, entities, is_sender, expiry, token, status, updated].hash
    end
