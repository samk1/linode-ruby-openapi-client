...
module LinodeOpenapiClient
  ...
  class GetBetaPrograms200ResponseAllOfDataInner
    ...
    def self.attribute_map
      {
        :'greenlight_only' => :'greenlight_only',
        :'id' => :'id',
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `LinodeOpenapiClient::GetBetaPrograms200ResponseAllOfDataInner` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `LinodeOpenapiClient::GetBetaPrograms200ResponseAllOfDataInner`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }

      if attributes.key?(:'greenlight_only')
        self.greenlight_only = attributes[:'greenlight_only']
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          greenlight_only == o.greenlight_only &&
          id == o.id &&
    ...
    def hash
      [greenlight_only, id, description, label, more_info, started, ended].hash
    end
