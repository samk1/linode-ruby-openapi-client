...
module LinodeOpenapiClient
  class PostAddStackScriptRequest
    ...
    def self.openapi_types
      {
        ...
        :'images' => :'Array<String>',
        :'rev_note' => :'String',
        :'user_defined_fields' => :'Array<PostAddStackScriptRequestAllOfUserDefinedFieldsInner>',
        :'username' => :'String',
        :'created' => :'Time',
        :'is_public' => :'Boolean',
        :'id' => :'Integer',
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `LinodeOpenapiClient::PostAddStackScriptRequest` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `LinodeOpenapiClient::PostAddStackScriptRequest`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
    ...
    def hash
      [updated, description, label, deployments_total, deployments_active, user_gravatar_id, script, images, rev_note, user_defined_fields, username, created, is_public, id, mine].hash
    end
