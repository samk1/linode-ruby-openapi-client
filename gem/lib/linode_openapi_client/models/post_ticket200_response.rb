  ...
  class PostTicket200Response
    ...
    def self.openapi_types
      {
        ...
        :'updated' => :'Time',
        :'closable' => :'Boolean',
        :'entity' => :'PostTicket200ResponseEntity',
        :'description' => :'String',
        :'summary' => :'String',
        :'gravatar_id' => :'String',
        :'opened_by' => :'String',
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `LinodeOpenapiClient::PostTicket200Response` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `LinodeOpenapiClient::PostTicket200Response`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
    ...
    def hash
      [updated_by, updated, closable, entity, description, summary, gravatar_id, opened_by, closed, attachments, opened, status, id].hash
    end
