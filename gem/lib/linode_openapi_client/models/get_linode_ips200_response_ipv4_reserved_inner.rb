...
module LinodeOpenapiClient
  ...
  class GetLinodeIps200ResponseIpv4ReservedInner
    ...
    def self.openapi_types
      {
        ...
        :'type' => :'String',
        :'public' => :'Boolean',
        :'vpc_nat_1_1' => :'GetLinodeIps200ResponseIpv4ReservedInnerVpcNat11',
        :'region' => :'String',
        :'address' => :'String'
      }
    end
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `LinodeOpenapiClient::GetLinodeIps200ResponseIpv4ReservedInner` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `LinodeOpenapiClient::GetLinodeIps200ResponseIpv4ReservedInner`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
    ...
    def hash
      [linode_id, gateway, subnet_mask, rdns, prefix, type, public, vpc_nat_1_1, region, address].hash
    end
