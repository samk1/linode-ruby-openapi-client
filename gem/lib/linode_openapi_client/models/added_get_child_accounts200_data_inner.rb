...
module LinodeOpenapiClient
  ...
  class AddedGetChildAccounts200DataInner
    ...
    def self.openapi_types
      {
        ...
        :'city' => :'String',
        :'state' => :'String',
        :'credit_card' => :'AddedGetChildAccounts200DataInnerCreditCard',
        :'euuid' => :'String',
        :'address_1' => :'String',
        :'country' => :'String',
        :'last_name' => :'String',
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `LinodeOpenapiClient::AddedGetChildAccounts200DataInner` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `LinodeOpenapiClient::AddedGetChildAccounts200DataInner`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
    ...
    def hash
      [zip, capabilities, address_2, first_name, active_since, balance, city, state, credit_card, euuid, address_1, country, last_name, balance_uninvoiced, email, billing_source, company, phone, tax_id].hash
    end
