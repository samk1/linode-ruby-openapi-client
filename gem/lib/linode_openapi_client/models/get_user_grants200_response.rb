...
module LinodeOpenapiClient
  ...
  class GetUserGrants200Response
    ...
    def self.openapi_types
      {
        ...
        :'global' => :'GetUserGrants200ResponseGlobal',
        :'stackscript' => :'Array<GetUserGrants200ResponseStackscriptInner>',
        :'nodebalancer' => :'Array<GetUserGrants200ResponsePlacementGroupInner>',
        :'volume' => :'Array<GetUserGrants200ResponseStackscriptInner>',
        :'vpc' => :'Array<GetUserGrants200ResponsePlacementGroupInner>',
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `LinodeOpenapiClient::GetUserGrants200Response` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `LinodeOpenapiClient::GetUserGrants200Response`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
    ...
    def hash
      [longview, loadbalancer, domain, placement_group, linode, image, global, stackscript, nodebalancer, volume, vpc, database].hash
    end
