...
module LinodeOpenapiClient
  class PostFirewallsRequest
    ...
    def self.openapi_types
      {
        :'rules' => :'PostFirewallsRequestRules',
        :'devices' => :'PostFirewallsRequestDevices',
        :'label' => :'String',
        :'id' => :'Integer',
        :'tags' => :'Array<String>',
        :'created' => :'Time',
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `LinodeOpenapiClient::PostFirewallsRequest` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `LinodeOpenapiClient::PostFirewallsRequest`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
    ...
    def valid?
      ...
      return false if @label !~ Regexp.new(/^[a-zA-Z]((?!--|__|..)[a-zA-Z0-9-_.])+$/)
    ...
    def hash
      [rules, devices, label, id, tags, created, status, updated].hash
    end
