...
module LinodeOpenapiClient
  class PutLinodeConfig200Response
    ...
    def self.openapi_types
      {
        ...
        :'root_device' => :'String',
        :'id' => :'Integer',
        :'interfaces' => :'Array<PutLinodeConfig200ResponseInterfacesInner>',
        :'devices' => :'PutLinodeConfig200ResponseDevices',
        :'run_level' => :'String',
        :'virt_mode' => :'String',
        :'memory_limit' => :'Integer',
        :'label' => :'String',
        :'helpers' => :'PutLinodeConfig200ResponseHelpers',
        :'kernel' => :'String'
      }
    end
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `LinodeOpenapiClient::PutLinodeConfig200Response` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `LinodeOpenapiClient::PutLinodeConfig200Response`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
    ...
    def hash
      [comments, root_device, id, interfaces, devices, run_level, virt_mode, memory_limit, label, helpers, kernel].hash
    end
