...
module LinodeOpenapiClient
  ...
  class GetDatabasesTypes200ResponseAllOfDataInner
    ...
    # __Filterable__ Whether this Database plan type has been deprecated and is no longer available.
    ...
    def self.openapi_types
      {
        :'memory' => :'Integer',
        :'disk' => :'Integer',
        :'engines' => :'GetDatabasesTypes200ResponseAllOfDataInnerEngines',
        :'_class' => :'String',
        :'label' => :'String',
        :'deprecated' => :'Boolean',
        :'vcpus' => :'Integer',
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `LinodeOpenapiClient::GetDatabasesTypes200ResponseAllOfDataInner` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `LinodeOpenapiClient::GetDatabasesTypes200ResponseAllOfDataInner`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
    ...
    def hash
      [memory, disk, engines, _class, label, deprecated, vcpus, id].hash
    end
