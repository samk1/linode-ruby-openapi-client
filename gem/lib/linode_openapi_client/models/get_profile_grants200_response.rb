...
module LinodeOpenapiClient
  ...
  class GetProfileGrants200Response
    ...
    def self.openapi_types
      {
        :'loadbalancer' => :'Array<GetUserGrants200ResponseLongviewInner>',
        :'longview' => :'Array<PutUserGrantsRequestStackscriptInner>',
        :'domain' => :'Array<GetUserGrants200ResponseLongviewInner>',
        :'global' => :'GetProfileGrants200ResponseGlobal',
        :'image' => :'Array<GetUserGrants200ResponseLongviewInner>',
        :'placement_group' => :'Array<GetUserGrants200ResponsePlacementGroupInner>',
        :'linode' => :'Array<GetUserGrants200ResponsePlacementGroupInner>',
        :'database' => :'Array<GetUserGrants200ResponsePlacementGroupInner>',
        :'volume' => :'Array<GetUserGrants200ResponsePlacementGroupInner>',
        :'stackscript' => :'Array<GetUserGrants200ResponsePlacementGroupInner>',
        :'nodebalancer' => :'Array<GetUserGrants200ResponseStackscriptInner>',
        :'vpc' => :'Array<GetUserGrants200ResponseStackscriptInner>'
      }
    end
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `LinodeOpenapiClient::GetProfileGrants200Response` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `LinodeOpenapiClient::GetProfileGrants200Response`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
    ...
    def hash
      [loadbalancer, longview, domain, global, image, placement_group, linode, database, volume, stackscript, nodebalancer, vpc].hash
    end
