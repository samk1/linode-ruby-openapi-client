...
module LinodeOpenapiClient
  ...
  class GetStackScript200Response
    ...
    def self.openapi_types
      {
        ...
        :'username' => :'String',
        :'rev_note' => :'String',
        :'user_defined_fields' => :'Array<GetStackScript200ResponseUserDefinedFieldsInner>'
      }
    end
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `LinodeOpenapiClient::GetStackScript200Response` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `LinodeOpenapiClient::GetStackScript200Response`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
    ...
    def hash
      [images, script, deployments_active, deployments_total, user_gravatar_id, label, description, updated, id, mine, created, is_public, username, rev_note, user_defined_fields].hash
    end
