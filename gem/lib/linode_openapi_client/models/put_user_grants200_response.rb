...
module LinodeOpenapiClient
  ...
  class PutUserGrants200Response
    ...
    def self.openapi_types
      {
        :'domain' => :'Array<GetUserGrants200ResponseStackscriptInner>',
        :'longview' => :'Array<GetUserGrants200ResponseStackscriptInner>',
        :'loadbalancer' => :'Array<GetUserGrants200ResponseStackscriptInner>',
        ...
        :'vpc' => :'Array<GetUserGrants200ResponseLongviewInner>',
        ...
        :'global' => :'PutUserGrants200ResponseGlobal'
      }
    end
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `LinodeOpenapiClient::PutUserGrants200Response` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `LinodeOpenapiClient::PutUserGrants200Response`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
    ...
    def hash
      [domain, longview, loadbalancer, volume, stackscript, nodebalancer, vpc, database, image, placement_group, linode, global].hash
    end
