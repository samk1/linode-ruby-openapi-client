...
module LinodeOpenapiClient
  ...
  class GetManagedContacts200ResponseDataInner
    ...
    def self.openapi_types
      {
        ...
        :'email' => :'String',
        :'group' => :'String',
        :'phone' => :'GetManagedContacts200ResponseDataInnerPhone',
        :'updated' => :'Time'
      }
    end
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `LinodeOpenapiClient::GetManagedContacts200ResponseDataInner` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `LinodeOpenapiClient::GetManagedContacts200ResponseDataInner`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
    ...
    def list_invalid_properties
      ...
      pattern = Regexp.new(/[a-zA-Z0-9-_ ]{2,64}/)
      ...
      if !@group.nil? && @group.to_s.length < 2
        invalid_properties.push('invalid value for "group", the character length must be great than or equal to 2.')
      end
    ...
    def valid?
      ...
      return false if !@name.nil? && @name !~ Regexp.new(/[a-zA-Z0-9-_ ]{2,64}/)
      return false if !@group.nil? && @group.to_s.length > 50
      return false if !@group.nil? && @group.to_s.length < 2
      true
    end
    ...
    def group=(group)
      ...
      if !group.nil? && group.to_s.length < 2
        fail ArgumentError, 'invalid value for "group", the character length must be great than or equal to 2.'
      end
    ...
    def hash
      [id, name, email, group, phone, updated].hash
    end
