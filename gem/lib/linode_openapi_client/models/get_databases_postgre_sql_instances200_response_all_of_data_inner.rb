...
module LinodeOpenapiClient
  ...
  class GetDatabasesPostgreSqlInstances200ResponseAllOfDataInner
    ...
    attr_accessor :replication_commit_type
    ...
    def self.openapi_types
      {
        ...
        :'engine' => :'String',
        :'updates' => :'GetDatabasesPostgreSqlInstances200ResponseAllOfDataInnerUpdates',
        :'port' => :'Integer',
        :'ssl_connection' => :'Boolean',
        :'hosts' => :'GetDatabasesPostgreSqlInstances200ResponseAllOfDataInnerHosts',
        :'status' => :'String',
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `LinodeOpenapiClient::GetDatabasesPostgreSqlInstances200ResponseAllOfDataInner` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `LinodeOpenapiClient::GetDatabasesPostgreSqlInstances200ResponseAllOfDataInner`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'replication_commit_type')
        self.replication_commit_type = attributes[:'replication_commit_type']
      else
        self.replication_commit_type = 'local'
      end
    ...
    def valid?
      ...
      replication_type_validator = EnumAttributeValidator.new('String', ["none", "asynch"])
      ...
      replication_commit_type_validator = EnumAttributeValidator.new('String', ["true", "local", "remote_write", "remote_apply", "false"])
      return false unless replication_commit_type_validator.valid?(@replication_commit_type)
    ...
    def replication_type=(replication_type)
      validator = EnumAttributeValidator.new('String', ["none", "asynch"])
    ...
    # Custom attribute writer method checking allowed values (enum).
    # @param [Object] replication_commit_type Object to be assigned
    def replication_commit_type=(replication_commit_type)
      validator = EnumAttributeValidator.new('String', ["true", "local", "remote_write", "remote_apply", "false"])
      unless validator.valid?(replication_commit_type)
        fail ArgumentError, "invalid value for \"replication_commit_type\", must be one of #{validator.allowable_values}."
      end
      @replication_commit_type = replication_commit_type
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          type == o.type &&
          label == o.label &&
          replication_commit_type == o.replication_commit_type &&
          engine == o.engine &&
          updates == o.updates &&
          port == o.port &&
    ...
    def hash
      [version, updated, replication_type, encrypted, type, label, replication_commit_type, engine, updates, port, ssl_connection, hosts, status, total_disk_size_gb, cluster_size, allow_list, region, created, used_disk_size_gb, id].hash
    end
