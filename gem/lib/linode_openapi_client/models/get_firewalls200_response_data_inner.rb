...
module LinodeOpenapiClient
  ...
  class GetFirewalls200ResponseDataInner
    ...
    def self.openapi_types
      {
        :'tags' => :'Array<String>',
        :'id' => :'Integer',
        :'rules' => :'GetFirewalls200ResponseDataInnerRules',
        :'created' => :'Time',
        :'label' => :'String',
        :'status' => :'String',
        :'updated' => :'Time'
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `LinodeOpenapiClient::GetFirewalls200ResponseDataInner` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `LinodeOpenapiClient::GetFirewalls200ResponseDataInner`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
    ...
    def hash
      [tags, id, rules, created, label, status, updated].hash
    end
