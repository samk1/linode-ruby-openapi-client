  ...
  class Linode1
    ...
    def self.openapi_types
      {
        ...
        :'placement_group' => :'Linode1PlacementGroup',
        :'image' => :'String',
        :'updated' => :'Time',
        :'label' => :'String',
        :'type' => :'String',
        ...
        :'status' => :'String',
        :'group' => :'String',
        :'alerts' => :'Linode1Alerts',
        :'host_uuid' => :'String',
        :'backups' => :'Linode1Backups'
      }
    end
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `LinodeOpenapiClient::Linode1` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `LinodeOpenapiClient::Linode1`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
    ...
    def hash
      [watchdog_enabled, has_user_data, placement_group, image, updated, label, type, region, ipv4, created, hypervisor, tags, id, ipv6, specs, status, group, alerts, host_uuid, backups].hash
    end
