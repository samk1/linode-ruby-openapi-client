  ...
  class PutAccountRequest
    ...
    def self.openapi_types
      {
        ...
        :'company' => :'String',
        :'active_promotions' => :'Array<PutAccountRequestActivePromotionsInner>',
        :'phone' => :'String',
        :'tax_id' => :'String',
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `LinodeOpenapiClient::PutAccountRequest` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `LinodeOpenapiClient::PutAccountRequest`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
    ...
    def hash
      [credit_card, active_since, balance, city, state, first_name, zip, address_2, capabilities, company, active_promotions, phone, tax_id, balance_uninvoiced, email, billing_source, country, last_name, euuid, address_1].hash
    end
