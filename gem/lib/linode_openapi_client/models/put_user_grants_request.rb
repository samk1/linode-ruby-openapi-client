  ...
  class PutUserGrantsRequest
    ...
    def self.openapi_types
      {
        ...
        :'longview' => :'Array<GetUserGrants200ResponseLongviewInner>',
        ...
        :'volume' => :'Array<GetUserGrants200ResponseStackscriptInner>',
        :'domain' => :'Array<GetUserGrants200ResponsePlacementGroupInner>',
        :'global' => :'PutUserGrantsRequestGlobal',
        :'stackscript' => :'Array<PutUserGrantsRequestStackscriptInner>',
        :'nodebalancer' => :'Array<GetUserGrants200ResponseLongviewInner>',
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `LinodeOpenapiClient::PutUserGrantsRequest` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `LinodeOpenapiClient::PutUserGrantsRequest`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
    ...
    def hash
      [loadbalancer, longview, linode, placement_group, image, database, volume, domain, global, stackscript, nodebalancer, vpc].hash
    end
