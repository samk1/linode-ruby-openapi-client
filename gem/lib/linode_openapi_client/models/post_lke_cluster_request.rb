  ...
  class PostLkeClusterRequest
    ...
    def self.openapi_types
      {
        ...
        :'region' => :'String',
        :'label' => :'String',
        :'control_plane' => :'PostLkeClusterRequestControlPlane',
        :'k8s_version' => :'String',
        :'node_pools' => :'Array<PostLkeClusterRequestNodePoolsInner>'
      }
    end
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `LinodeOpenapiClient::PostLkeClusterRequest` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `LinodeOpenapiClient::PostLkeClusterRequest`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
    ...
    def list_invalid_properties
      ...
      if @node_pools.nil?
        invalid_properties.push('invalid value for "node_pools", node_pools cannot be nil.')
      end
    ...
    def valid?
      ...
      return false if @node_pools.nil?
      true
    end
    ...
    def hash
      [tags, region, label, control_plane, k8s_version, node_pools].hash
    end
