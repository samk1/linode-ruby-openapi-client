...
module LinodeOpenapiClient
  ...
  class GetNodeBalancerFirewalls200ResponseAllOfDataInnerRulesOutboundInner
    ...
    def self.openapi_types
      {
        :'ports' => :'String',
        :'addresses' => :'GetFirewall200ResponseRulesInboundInnerAddresses',
        :'protocol' => :'String',
        :'description' => :'String',
        :'label' => :'String',
        :'action' => :'String'
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `LinodeOpenapiClient::GetNodeBalancerFirewalls200ResponseAllOfDataInnerRulesOutboundInner` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `LinodeOpenapiClient::GetNodeBalancerFirewalls200ResponseAllOfDataInnerRulesOutboundInner`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
    ...
    def hash
      [ports, addresses, protocol, description, label, action].hash
    end
