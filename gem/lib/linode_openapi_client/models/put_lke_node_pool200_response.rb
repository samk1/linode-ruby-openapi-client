...
module LinodeOpenapiClient
  ...
  class PutLkeNodePool200Response
    ...
    def self.openapi_types
      {
        ...
        :'tags' => :'Array<String>',
        :'id' => :'Integer',
        :'autoscaler' => :'PutLkeNodePool200ResponseAutoscaler',
        :'type' => :'String',
        :'labels' => :'PostLkeClusterPools200ResponseLabels',
        :'taints' => :'Array<PutLkeNodePool200ResponseTaintsInner>',
        :'count' => :'Integer',
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `LinodeOpenapiClient::PutLkeNodePool200Response` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `LinodeOpenapiClient::PutLkeNodePool200Response`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
    ...
    def hash
      [nodes, tags, id, autoscaler, type, labels, taints, count, disks].hash
    end
