...
module LinodeOpenapiClient
  ...
  class GetIps200ResponseAllOfDataInner
    ...
    def self.openapi_types
      {
        :'address' => :'String',
        :'region' => :'String',
        :'vpc_nat_1_1' => :'GetIps200ResponseAllOfDataInnerVpcNat11',
        :'gateway' => :'String',
        :'linode_id' => :'Integer',
        :'rdns' => :'String',
        :'prefix' => :'Integer',
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `LinodeOpenapiClient::GetIps200ResponseAllOfDataInner` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `LinodeOpenapiClient::GetIps200ResponseAllOfDataInner`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
    ...
    def hash
      [address, region, vpc_nat_1_1, gateway, linode_id, rdns, prefix, subnet_mask, public, type].hash
    end
