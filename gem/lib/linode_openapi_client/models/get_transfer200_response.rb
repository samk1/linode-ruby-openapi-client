...
module LinodeOpenapiClient
  ...
  class GetTransfer200Response
    attr_accessor :region_transfers
    ...
    def self.attribute_map
      {
        :'region_transfers' => :'region_transfers',
        :'used' => :'used',
        :'quota' => :'quota',
        :'billable' => :'billable'
      }
    ...
    def self.openapi_types
      {
        :'region_transfers' => :'Array<GetTransfer200ResponseRegionTransfersInner>',
        :'used' => :'Integer',
        :'quota' => :'Integer',
        :'billable' => :'Integer'
      }
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `LinodeOpenapiClient::GetTransfer200Response` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `LinodeOpenapiClient::GetTransfer200Response`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }

      if attributes.key?(:'region_transfers')
        if (value = attributes[:'region_transfers']).is_a?(Array)
          self.region_transfers = value
        end
      end
    ...
    def hash
      [region_transfers, used, quota, billable].hash
    end
