...
module LinodeOpenapiClient
  class PostAttachVolumeRequest
    ...
    attr_accessor :persist_across_boots
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `LinodeOpenapiClient::PostAttachVolumeRequest` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `LinodeOpenapiClient::PostAttachVolumeRequest`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'persist_across_boots')
        self.persist_across_boots = attributes[:'persist_across_boots']
      end
    end
    ...
    def list_invalid_properties
      ...
      if @linode_id.nil?
        invalid_properties.push('invalid value for "linode_id", linode_id cannot be nil.')
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          persist_across_boots == o.persist_across_boots
    end
    ...
    def hash
      [linode_id, config_id, persist_across_boots].hash
    end
