  ...
  class PutStackScriptRequest
    ...
    def self.openapi_types
      {
        ...
        :'script' => :'String',
        :'images' => :'Array<String>',
        :'user_defined_fields' => :'Array<PutStackScriptRequestUserDefinedFieldsInner>',
        :'rev_note' => :'String',
        :'username' => :'String',
        :'is_public' => :'Boolean',
        :'created' => :'Time',
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `LinodeOpenapiClient::PutStackScriptRequest` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `LinodeOpenapiClient::PutStackScriptRequest`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
    ...
    def hash
      [updated, label, description, user_gravatar_id, deployments_total, deployments_active, script, images, user_defined_fields, rev_note, username, is_public, created, mine, id].hash
    end
