...
module LinodeOpenapiClient
  ...
  class PutAccount200Response
    ...
    def self.openapi_types
      {
        :'credit_card' => :'GetAccount200ResponseCreditCard',
        :'state' => :'String',
        :'city' => :'String',
        :'balance' => :'Float',
        :'active_since' => :'Time',
        ...
        :'tax_id' => :'String',
        :'phone' => :'String',
        :'active_promotions' => :'Array<PutAccount200ResponseActivePromotionsInner>',
        :'company' => :'String',
        :'email' => :'String',
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `LinodeOpenapiClient::PutAccount200Response` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `LinodeOpenapiClient::PutAccount200Response`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
    ...
    def hash
      [credit_card, state, city, balance, active_since, first_name, capabilities, address_2, zip, tax_id, phone, active_promotions, company, email, billing_source, balance_uninvoiced, last_name, country, address_1, euuid].hash
    end
