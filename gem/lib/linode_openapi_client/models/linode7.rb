  ...
  class Linode7
    ...
    def self.openapi_types
      {
        ...
        :'status' => :'String',
        :'host_uuid' => :'String',
        :'backups' => :'Linode7Backups',
        :'alerts' => :'Linode7Alerts',
        :'created' => :'Time',
        :'ipv4' => :'Array<String>',
        :'region' => :'String',
        :'id' => :'Integer',
        ...
        :'placement_group' => :'Linode7PlacementGroup',
        :'image' => :'String',
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `LinodeOpenapiClient::Linode7` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `LinodeOpenapiClient::Linode7`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
    ...
    def hash
      [group, status, host_uuid, backups, alerts, created, ipv4, region, id, specs, ipv6, hypervisor, tags, updated, type, label, watchdog_enabled, placement_group, image, has_user_data].hash
    end
