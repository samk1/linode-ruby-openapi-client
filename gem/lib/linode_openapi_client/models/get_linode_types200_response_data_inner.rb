...
module LinodeOpenapiClient
  ...
  class GetLinodeTypes200ResponseDataInner
    ...
    def self.openapi_types
      {
        :'addons' => :'GetLinodeTypes200ResponseDataInnerAddons',
        :'network_out' => :'Integer',
        :'id' => :'String',
        :'memory' => :'Integer',
        :'disk' => :'Integer',
        ...
        :'label' => :'String',
        :'region_prices' => :'Array<GetLinodeTypes200ResponseDataInnerRegionPricesInner>'
      }
    end
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `LinodeOpenapiClient::GetLinodeTypes200ResponseDataInner` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `LinodeOpenapiClient::GetLinodeTypes200ResponseDataInner`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
