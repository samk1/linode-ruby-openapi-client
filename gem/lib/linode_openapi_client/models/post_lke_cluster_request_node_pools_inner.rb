...
module LinodeOpenapiClient
  ...
  class PostLkeClusterRequestNodePoolsInner
    ...
    def self.openapi_types
      {
        :'taints' => :'Array<PostLkeClusterRequestNodePoolsInnerTaintsInner>',
        :'disks' => :'Array<PostLkeClusterRequestNodePoolsInnerDisksInner>',
        :'count' => :'Integer',
        :'tags' => :'Array<String>',
        :'type' => :'String',
        :'labels' => :'Array<Object>',
        :'autoscaler' => :'PostLkeClusterRequestNodePoolsInnerAutoscaler'
      }
    end
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `LinodeOpenapiClient::PostLkeClusterRequestNodePoolsInner` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `LinodeOpenapiClient::PostLkeClusterRequestNodePoolsInner`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
    ...
    def list_invalid_properties
      ...
      if !@taints.nil? && @taints.length < 1
        invalid_properties.push('invalid value for "taints", number of items must be greater than or equal to 1.')
      end
    ...
    def valid?
      ...
      return false if !@taints.nil? && @taints.length < 1
    ...
    # @param [Object] taints Value to be assigned
    def taints=(taints)
      if taints.nil?
        fail ArgumentError, 'taints cannot be nil'
      end

      if taints.length < 1
        fail ArgumentError, 'invalid value for "taints", number of items must be greater than or equal to 1.'
      end
    ...
    def hash
      [taints, disks, count, tags, type, labels, autoscaler].hash
    end
