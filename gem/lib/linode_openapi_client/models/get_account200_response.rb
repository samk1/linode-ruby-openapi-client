  ...
  class GetAccount200Response
    ...
    def self.openapi_types
      {
        ...
        :'email' => :'String',
        :'active_promotions' => :'Array<GetAccount200ResponseActivePromotionsInner>',
        :'phone' => :'String',
        :'company' => :'String',
        :'tax_id' => :'String'
      }
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `LinodeOpenapiClient::GetAccount200Response` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `LinodeOpenapiClient::GetAccount200Response`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
    ...
    def hash
      [zip, address_2, capabilities, first_name, active_since, state, city, balance, credit_card, address_1, euuid, country, last_name, balance_uninvoiced, billing_source, email, active_promotions, phone, company, tax_id].hash
    end
