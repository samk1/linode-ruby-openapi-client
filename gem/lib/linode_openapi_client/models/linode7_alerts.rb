  ...
  class Linode7Alerts
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `LinodeOpenapiClient::Linode7Alerts` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `LinodeOpenapiClient::Linode7Alerts`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'transfer_quota')
        self.transfer_quota = attributes[:'transfer_quota']
      end
      ...
      if attributes.key?(:'network_in')
        self.network_in = attributes[:'network_in']
      end
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          io == o.io &&
          transfer_quota == o.transfer_quota &&
          cpu == o.cpu &&
          network_out == o.network_out &&
          network_in == o.network_in
    end
    ...
    def hash
      [io, transfer_quota, cpu, network_out, network_in].hash
    end
