...
module LinodeOpenapiClient
  ...
  class GetNodeBalancerFirewalls200ResponseAllOfDataInner
    ...
    def self.openapi_types
      {
        :'created' => :'Time',
        :'rules' => :'GetNodeBalancerFirewalls200ResponseAllOfDataInnerRules',
        :'id' => :'Integer',
        :'tags' => :'Array<String>',
        :'updated' => :'Time',
        :'status' => :'String',
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `LinodeOpenapiClient::GetNodeBalancerFirewalls200ResponseAllOfDataInner` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `LinodeOpenapiClient::GetNodeBalancerFirewalls200ResponseAllOfDataInner`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
    ...
    def hash
      [created, rules, id, tags, updated, status, label].hash
    end
