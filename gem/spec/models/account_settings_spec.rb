...
# Unit tests for LinodeOpenapiClient::AccountSettings
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe LinodeOpenapiClient::AccountSettings do
  let(:instance) { LinodeOpenapiClient::AccountSettings.new }

  describe 'test an instance of AccountSettings' do
    it 'should create an instance of AccountSettings' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(LinodeOpenapiClient::AccountSettings)
    end
  end
