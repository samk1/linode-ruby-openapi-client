...
# Unit tests for LinodeOpenapiClient::PostNodeBalancerRequestConfigsInner
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe LinodeOpenapiClient::PostNodeBalancerRequestConfigsInner do
  let(:instance) { LinodeOpenapiClient::PostNodeBalancerRequestConfigsInner.new }

  describe 'test an instance of PostNodeBalancerRequestConfigsInner' do
    it 'should create an instance of PostNodeBalancerRequestConfigsInner' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(LinodeOpenapiClient::PostNodeBalancerRequestConfigsInner)
    end
  end
