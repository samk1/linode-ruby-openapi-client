...
# Unit tests for LinodeOpenapiClient::Event
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe LinodeOpenapiClient::Event do
  let(:instance) { LinodeOpenapiClient::Event.new }

  describe 'test an instance of Event' do
    it 'should create an instance of Event' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(LinodeOpenapiClient::Event)
    end
  end
