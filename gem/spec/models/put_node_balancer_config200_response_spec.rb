...
# Unit tests for LinodeOpenapiClient::PutNodeBalancerConfig200Response
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe LinodeOpenapiClient::PutNodeBalancerConfig200Response do
  let(:instance) { LinodeOpenapiClient::PutNodeBalancerConfig200Response.new }

  describe 'test an instance of PutNodeBalancerConfig200Response' do
    it 'should create an instance of PutNodeBalancerConfig200Response' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(LinodeOpenapiClient::PutNodeBalancerConfig200Response)
    end
  end
