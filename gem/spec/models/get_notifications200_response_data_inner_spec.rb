...
# Unit tests for LinodeOpenapiClient::GetNotifications200ResponseDataInner
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe LinodeOpenapiClient::GetNotifications200ResponseDataInner do
  let(:instance) { LinodeOpenapiClient::GetNotifications200ResponseDataInner.new }

  describe 'test an instance of GetNotifications200ResponseDataInner' do
    it 'should create an instance of GetNotifications200ResponseDataInner' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(LinodeOpenapiClient::GetNotifications200ResponseDataInner)
    end
  end
