...
# Unit tests for LinodeOpenapiClient::GetNodeBalancerConfigs200ResponseDataInner
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe LinodeOpenapiClient::GetNodeBalancerConfigs200ResponseDataInner do
  let(:instance) { LinodeOpenapiClient::GetNodeBalancerConfigs200ResponseDataInner.new }

  describe 'test an instance of GetNodeBalancerConfigs200ResponseDataInner' do
    it 'should create an instance of GetNodeBalancerConfigs200ResponseDataInner' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(LinodeOpenapiClient::GetNodeBalancerConfigs200ResponseDataInner)
    end
  end
