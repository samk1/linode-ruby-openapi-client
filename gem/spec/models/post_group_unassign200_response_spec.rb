...
# Unit tests for LinodeOpenapiClient::PostGroupUnassign200Response
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe LinodeOpenapiClient::PostGroupUnassign200Response do
  let(:instance) { LinodeOpenapiClient::PostGroupUnassign200Response.new }

  describe 'test an instance of PostGroupUnassign200Response' do
    it 'should create an instance of PostGroupUnassign200Response' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(LinodeOpenapiClient::PostGroupUnassign200Response)
    end
  end
