...
# Unit tests for LinodeOpenapiClient::Linode6PlacementGroup
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe LinodeOpenapiClient::Linode6PlacementGroup do
  let(:instance) { LinodeOpenapiClient::Linode6PlacementGroup.new }

  describe 'test an instance of Linode6PlacementGroup' do
    it 'should create an instance of Linode6PlacementGroup' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(LinodeOpenapiClient::Linode6PlacementGroup)
    end
  end
