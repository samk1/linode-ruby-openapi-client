...
# Unit tests for LinodeOpenapiClient::PutPlacementGroup200Response
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe LinodeOpenapiClient::PutPlacementGroup200Response do
  let(:instance) { LinodeOpenapiClient::PutPlacementGroup200Response.new }

  describe 'test an instance of PutPlacementGroup200Response' do
    it 'should create an instance of PutPlacementGroup200Response' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(LinodeOpenapiClient::PutPlacementGroup200Response)
    end
  end
