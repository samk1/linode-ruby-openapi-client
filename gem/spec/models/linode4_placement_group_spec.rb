...
# Unit tests for LinodeOpenapiClient::Linode4PlacementGroup
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe LinodeOpenapiClient::Linode4PlacementGroup do
  let(:instance) { LinodeOpenapiClient::Linode4PlacementGroup.new }

  describe 'test an instance of Linode4PlacementGroup' do
    it 'should create an instance of Linode4PlacementGroup' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(LinodeOpenapiClient::Linode4PlacementGroup)
    end
  end
