...
# Unit tests for LinodeOpenapiClient::PostAddLinodeConfig200Response
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe LinodeOpenapiClient::PostAddLinodeConfig200Response do
  let(:instance) { LinodeOpenapiClient::PostAddLinodeConfig200Response.new }

  describe 'test an instance of PostAddLinodeConfig200Response' do
    it 'should create an instance of PostAddLinodeConfig200Response' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(LinodeOpenapiClient::PostAddLinodeConfig200Response)
    end
  end
