...
# Unit tests for LinodeOpenapiClient::GetNodeBalancerConfig200Response
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe LinodeOpenapiClient::GetNodeBalancerConfig200Response do
  let(:instance) { LinodeOpenapiClient::GetNodeBalancerConfig200Response.new }

  describe 'test an instance of GetNodeBalancerConfig200Response' do
    it 'should create an instance of GetNodeBalancerConfig200Response' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(LinodeOpenapiClient::GetNodeBalancerConfig200Response)
    end
  end
