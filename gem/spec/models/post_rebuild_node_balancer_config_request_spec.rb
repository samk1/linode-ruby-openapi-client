...
# Unit tests for LinodeOpenapiClient::PostRebuildNodeBalancerConfigRequest
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe LinodeOpenapiClient::PostRebuildNodeBalancerConfigRequest do
  let(:instance) { LinodeOpenapiClient::PostRebuildNodeBalancerConfigRequest.new }

  describe 'test an instance of PostRebuildNodeBalancerConfigRequest' do
    it 'should create an instance of PostRebuildNodeBalancerConfigRequest' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(LinodeOpenapiClient::PostRebuildNodeBalancerConfigRequest)
    end
  end
