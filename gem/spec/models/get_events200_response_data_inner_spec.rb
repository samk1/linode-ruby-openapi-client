...
# Unit tests for LinodeOpenapiClient::GetEvents200ResponseDataInner
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe LinodeOpenapiClient::GetEvents200ResponseDataInner do
  let(:instance) { LinodeOpenapiClient::GetEvents200ResponseDataInner.new }

  describe 'test an instance of GetEvents200ResponseDataInner' do
    it 'should create an instance of GetEvents200ResponseDataInner' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(LinodeOpenapiClient::GetEvents200ResponseDataInner)
    end
  end
