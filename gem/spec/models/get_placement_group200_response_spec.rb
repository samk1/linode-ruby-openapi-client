...
# Unit tests for LinodeOpenapiClient::GetPlacementGroup200Response
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe LinodeOpenapiClient::GetPlacementGroup200Response do
  let(:instance) { LinodeOpenapiClient::GetPlacementGroup200Response.new }

  describe 'test an instance of GetPlacementGroup200Response' do
    it 'should create an instance of GetPlacementGroup200Response' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(LinodeOpenapiClient::GetPlacementGroup200Response)
    end
  end
