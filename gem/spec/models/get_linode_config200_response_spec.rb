...
# Unit tests for LinodeOpenapiClient::GetLinodeConfig200Response
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe LinodeOpenapiClient::GetLinodeConfig200Response do
  let(:instance) { LinodeOpenapiClient::GetLinodeConfig200Response.new }

  describe 'test an instance of GetLinodeConfig200Response' do
    it 'should create an instance of GetLinodeConfig200Response' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(LinodeOpenapiClient::GetLinodeConfig200Response)
    end
  end
