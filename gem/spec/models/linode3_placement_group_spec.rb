...
# Unit tests for LinodeOpenapiClient::Linode3PlacementGroup
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe LinodeOpenapiClient::Linode3PlacementGroup do
  let(:instance) { LinodeOpenapiClient::Linode3PlacementGroup.new }

  describe 'test an instance of Linode3PlacementGroup' do
    it 'should create an instance of Linode3PlacementGroup' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(LinodeOpenapiClient::Linode3PlacementGroup)
    end
  end
