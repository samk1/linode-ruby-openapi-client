...
# Unit tests for LinodeOpenapiClient::PostPlacementGroup200Response
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe LinodeOpenapiClient::PostPlacementGroup200Response do
  let(:instance) { LinodeOpenapiClient::PostPlacementGroup200Response.new }

  describe 'test an instance of PostPlacementGroup200Response' do
    it 'should create an instance of PostPlacementGroup200Response' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(LinodeOpenapiClient::PostPlacementGroup200Response)
    end
  end
