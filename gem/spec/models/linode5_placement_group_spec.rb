...
# Unit tests for LinodeOpenapiClient::Linode5PlacementGroup
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe LinodeOpenapiClient::Linode5PlacementGroup do
  let(:instance) { LinodeOpenapiClient::Linode5PlacementGroup.new }

  describe 'test an instance of Linode5PlacementGroup' do
    it 'should create an instance of Linode5PlacementGroup' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(LinodeOpenapiClient::Linode5PlacementGroup)
    end
  end
