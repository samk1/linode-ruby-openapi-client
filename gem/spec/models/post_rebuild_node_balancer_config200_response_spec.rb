...
# Unit tests for LinodeOpenapiClient::PostRebuildNodeBalancerConfig200Response
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe LinodeOpenapiClient::PostRebuildNodeBalancerConfig200Response do
  let(:instance) { LinodeOpenapiClient::PostRebuildNodeBalancerConfig200Response.new }

  describe 'test an instance of PostRebuildNodeBalancerConfig200Response' do
    it 'should create an instance of PostRebuildNodeBalancerConfig200Response' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(LinodeOpenapiClient::PostRebuildNodeBalancerConfig200Response)
    end
  end
