...
# Unit tests for LinodeOpenapiClient::PostPlacementGroupRequest
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe LinodeOpenapiClient::PostPlacementGroupRequest do
  let(:instance) { LinodeOpenapiClient::PostPlacementGroupRequest.new }

  describe 'test an instance of PostPlacementGroupRequest' do
    it 'should create an instance of PostPlacementGroupRequest' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(LinodeOpenapiClient::PostPlacementGroupRequest)
    end
  end
