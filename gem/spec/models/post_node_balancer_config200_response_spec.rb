...
# Unit tests for LinodeOpenapiClient::PostNodeBalancerConfig200Response
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe LinodeOpenapiClient::PostNodeBalancerConfig200Response do
  let(:instance) { LinodeOpenapiClient::PostNodeBalancerConfig200Response.new }

  describe 'test an instance of PostNodeBalancerConfig200Response' do
    it 'should create an instance of PostNodeBalancerConfig200Response' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(LinodeOpenapiClient::PostNodeBalancerConfig200Response)
    end
  end
