...
# Unit tests for LinodeOpenapiClient::PostGroupAddLinode200Response
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe LinodeOpenapiClient::PostGroupAddLinode200Response do
  let(:instance) { LinodeOpenapiClient::PostGroupAddLinode200Response.new }

  describe 'test an instance of PostGroupAddLinode200Response' do
    it 'should create an instance of PostGroupAddLinode200Response' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(LinodeOpenapiClient::PostGroupAddLinode200Response)
    end
  end
