...
# Unit tests for LinodeOpenapiClient::PostAddLinodeConfigRequest
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe LinodeOpenapiClient::PostAddLinodeConfigRequest do
  let(:instance) { LinodeOpenapiClient::PostAddLinodeConfigRequest.new }

  describe 'test an instance of PostAddLinodeConfigRequest' do
    it 'should create an instance of PostAddLinodeConfigRequest' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(LinodeOpenapiClient::PostAddLinodeConfigRequest)
    end
  end
