...
# Unit tests for LinodeOpenapiClient::Linode1BackupsSchedule
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe LinodeOpenapiClient::Linode1BackupsSchedule do
  let(:instance) { LinodeOpenapiClient::Linode1BackupsSchedule.new }

  describe 'test an instance of Linode1BackupsSchedule' do
    it 'should create an instance of Linode1BackupsSchedule' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(LinodeOpenapiClient::Linode1BackupsSchedule)
    end
  end
