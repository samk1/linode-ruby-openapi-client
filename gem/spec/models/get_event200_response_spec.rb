...
# Unit tests for LinodeOpenapiClient::GetEvent200Response
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe LinodeOpenapiClient::GetEvent200Response do
  let(:instance) { LinodeOpenapiClient::GetEvent200Response.new }

  describe 'test an instance of GetEvent200Response' do
    it 'should create an instance of GetEvent200Response' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(LinodeOpenapiClient::GetEvent200Response)
    end
  end
