...
# Unit tests for LinodeOpenapiClient::Linode1PlacementGroup
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe LinodeOpenapiClient::Linode1PlacementGroup do
  let(:instance) { LinodeOpenapiClient::Linode1PlacementGroup.new }

  describe 'test an instance of Linode1PlacementGroup' do
    it 'should create an instance of Linode1PlacementGroup' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(LinodeOpenapiClient::Linode1PlacementGroup)
    end
  end
