...
# Unit tests for LinodeOpenapiClient::Linode2PlacementGroup
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe LinodeOpenapiClient::Linode2PlacementGroup do
  let(:instance) { LinodeOpenapiClient::Linode2PlacementGroup.new }

  describe 'test an instance of Linode2PlacementGroup' do
    it 'should create an instance of Linode2PlacementGroup' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(LinodeOpenapiClient::Linode2PlacementGroup)
    end
  end
